 ...
 */
export function buildVerificationHash(sharedSecret, { reference, amount, currency, hideCardHolder, returnPath }) {
...
export function verifyPurchaseResponse(sharedSecret, { responseCode, successful, amount, currency, id, token, verification }) {
...
export function verifyTokenizeResponse(sharedSecret, { responseCode, token, verification }) {
