...
export default function App() {
  ...
  return (
    <>
      <h1>ArtsPay 3D Secure (fatzebra.js): React example</h1>
      <p>
        Renders ArtsPay's Hosted Payments Page through fatzebra.js with 3D Secure 2 enabled
        (<code>enableSca: true</code>). fatzebra.js tokenizes the card, runs the 3DS2 check,
        then submits the purchase itself: this page only reacts to its events, and the backend
        only ever mints a short-lived OAuth token and signs the request/response hashes; it
        never sees the card directly.
      </p>
      <p>
