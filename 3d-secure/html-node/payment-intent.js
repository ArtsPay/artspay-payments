...
// be visible in the browser. See
// https://artspay.com/docs/guides/3d-secure and Fat Zebra's PaymentIntent
// reference for the worked example this matches.
function buildPaymentIntentVerification(sharedSecret, { reference, amountCents, currency, hideCardHolder }) {
...
module.exports = { buildPaymentIntentVerification };
